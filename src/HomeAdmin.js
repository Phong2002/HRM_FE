  ...
  navigate("./"+newValue);
    ...
    <Box className="nav">
      ...
      >
        ...
        <Tab value="records" label="Quản lý hồ sơ" />
        <Tab value="salary" label="Quản lý lương thưởng" />
        <Tab value="department" label="Quản lý phòng ban" />
        <Tab value="notify" label="Thông báo" />
        <Tab value="account" label="Quản lý tài khoản" />
      </Tabs>
    </Box>
